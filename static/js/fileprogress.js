...
//		progressCancel.appendChild(document.createTextNode(" "));
		...
		var delImage = document.createElement("a");
        delImage.className = "delImage";
        delImage.href = "#";
        delImage.title = '删除';
        delImage.style.visibility = "hidden";
        delImage.appendChild(document.createTextNode("删除"));
		...
		this.fileProgressElement.appendChild(delImage);
...
// Show/Hide the delImage button
FileProgress.prototype.toggleDel = function (show, swfUploadInstance) {
	this.fileProgressElement.childNodes[1].style.visibility = show ? "visible" : "hidden";
	if (swfUploadInstance) {
		var fileID = this.fileProgressID;
        var ImageId = this.fileProgressElement.childNodes[2].childNodes[1].value;

		this.fileProgressElement.childNodes[1].onclick = function () {
            deleteUpload(ImageId,fileID);
			return false;
		};
	}
};
