...
<html>
<head>
    <title>青春在线创投基金协议-<?php echo $GLOBALS['setting']['site_title']; ?></title>
    ...
    <meta name="description"
          content="<?php echo $GLOBALS['setting']['seo_description']; ?>">
    ...
    <div class="container">
        ...
        <div class="about-section-grids2">
            <div class="col-md-12 about-section-grid2">
                <p>如您需使用青春在线创投基金服务，则需同意本规则。</p>

                <p>您理解并同意：</p>

                <p>您承诺对您所上传的图片、文字、视频、音频等内容拥有完整著作权或已获得合法授权，未侵犯任何第三方之合法权益。</p>
                <p>您承诺您所上传的企业营业执照、产品图片、商业计划书、战略规划、融资金额等资料信息真实有效。</p>
                <p>您上传的图片、文字、视频、音频等内容中，不得含有：</p>
                <p>.（1）违反国家法律、危害国家安全统一、社会稳定、公序良俗、社会公德以及侮辱、诽谤、淫秽或含有任何性或性暗示的、暴力的内容；</p>
                <p>.（2）侵害他人名誉权、肖像权、知识产权、商业秘密等合法权利的内容；</p>
                <p>.（3）涉及他人隐私、个人信息或资料的；</p>
                <p>.（4）骚扰、广告信息及垃圾信息；</p>
                <p>.（5）其他违反法律法规、政策及公序良俗、社会公德或干扰正常运营和侵犯其他用户或第三方合法权益内容的信息。</p>
                <p>您将对因您的上传行为导致的纠纷承担全部法律责任。</p>
                <p>一旦发现您上传的图片、文字、视频、音频等内容中含有上述第3条中所述内容，青春在线创投基金平台有权不经通知随时删除该内容。</p>
                <p>您充分理解并同意，您的作品一旦在青春在线创投基金平台上发布，则本平台有权将您所提交的作品同步至其他业务平台。</p>
            </div>
            <div class="clearfix"></div>
        </div>
    </div>
