...
<div class="about-section">
    ...
    <div class="container" style="border: 2px #e6e6e6 solid">
        ...
        <form id="123">
            <div class="member_con registerm">
                ...
                <label class="form-con cb" style=""><input type="text" class="fl" id="id_email"/><span
                        class="fl commom">邮箱，只有管理员可见</span></label>
                <label class="form-con cb" style=""><input type="text" class="fl"
                                                                               id="id_weichart"/><span
                ...
                <span class="commom" style="position:absolute;top:39px;left:240px;"><a href="#" id="reduceGg">(删除)</a></span>
                <span class="commom" style="position:absolute;top:0px;left:240px;"><a href="#" id="addGg">(添加)</a></span>
                        ...
                        <div class="ggdiv fl cl" style="padding-top: 8px;">
                ...
                <label class="form-con cb"><h3 class="fl user-upload-labelm">上传营业执照图片:</h3>
                ...
                <label class="form-con cb "><h3 class="fl user-upload-labelm"><b>*</b>上传产品图片:</h3>
                ...
                <label class="form-con cb "><h3 class="fl user-upload-labelm" >上传产品二维码:</h3><a
                ...
                <label class="form-con cb upload_image_4"><h3 class="fl user-upload-labelm" >上传商业计划书、战略规划:</h3><a
                ...
                <div class="reg_gzm"><i id="reg_rule_id"></i><span>请您确认已阅读并同意遵守<a href="<?php echo $GLOBALS['app']['scheme']; ?>://<?php echo $GLOBALS['app']['host']; ?>/project/regrule" target="_blank">《青春在线创投基金协议》</a></span></div>
                <p class="member_submitm fl">
