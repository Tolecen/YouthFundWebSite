...
<div class="subnav">
    <div class="content-menu ib-a blue line-x">
        <A HREF="index.php?con=<?php echo $GLOBALS['setting']['adminpath']; ?>&act=zhiku"><em>全部</em></A>
    </div>
</div>
...
<div id="man_zone">
    <form action="index.php?con=<?php echo $GLOBALS['setting']['adminpath']; ?>&act=zhikumodify" method="post"
          onsubmit="return checkform(this);">
        <INPUT TYPE="hidden" NAME="commit" value="1">
        <INPUT TYPE="hidden" NAME="updateid" value="<?php echo $zhiku['topic_id']; ?>">
        <table width="90%" class="table_form">
            <tbody>
            <tr height="50">
                <td width="80" class="asdasd">姓名</td>
                <td>
                    <input type="text" id="media_title" value="<?php echo $zhiku['topic_name']; ?>" class="input-text"
            ...
            <tr height="50">
                ...
                <td>
                    ...
                    <textarea id="topic_intro" name="topic_intro" style="width:450px; height: 100px; font-size: 14px;text-align: left"><?php if (isset($zhiku['topic_intro'])) {
                            echo $zhiku['topic_intro'];
                        } ?></textarea>
            ...
            <tr>
                <td>头像</td>
                <td height="160">
                    <input type="hidden" size="30" id="tag_file_id" class="input-text" value="<?php echo $zhiku['file_id'];?>" name="tag_file_id">
                    ...
                    <form id="pin_multi_form" action="" method="post" enctype="multipart/form-data">
                        <div id="fsUploadProgress" class="fieldset flash">
                            <?php if(isset($zhiku['file_id']) && $zhiku['file_id'] > 0){;?>
                                <div class="progressWrapper" id="SWFUpload_0_0" style="opacity: 1;">
                                    <div class="progressContainer blue">
                                        ...
                                        <div class="progressBarStatus">
                                            <span class="photo-thumb"><img width="150" src="<?php echo $GLOBALS['app']['scheme'];?>://<?php echo $GLOBALS['app']['host'];?>/<?php echo $zhiku['file']['host'].$zhiku['file']['file_path'].$zhiku['file']['file_original']; ?>" /></span>
                                            <input type="hidden" name="file_id" value="<?php echo $zhiku['file_id'];?>" class="img_ids" />
                                        </div>
            ...
            <tr>
                ...
                <td>
                    <textarea id="txt-content" data-autosave="editor-content" autofocus required>
                        <?php if (isset($zhiku['topic_desc'])) {
                            echo $zhiku['topic_desc'];
                        } ?>
                    </textarea>
                </td>
            </tr>
